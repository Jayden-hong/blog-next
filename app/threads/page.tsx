...
// Read all threads server-side at build time
...
export default function ThreadsPage({ searchParams }: PageProps) {
  // Get URL params - this works at request time for non-static builds
  // For static export, we need client-side JavaScript
  ...
  return (
    <div className="min-h-screen" data-lang={lang} data-page={currentPage}>
      <div className="max-w-3xl mx-auto px-4 py-12">
        <header className="mb-10">
          ...
          <p className="text-xs text-red-500 mt-2">
            Server-rendered: lang={lang}, page={currentPage}, filtered={totalItems}
          </p>
        </header>

        {/* Language Filter - Using plain anchors for static export compatibility */}
              ...
              <article key={thread.id} className="group border-b border-neutral-100 pb-6 last:border-0">
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mt-3 text-xs text-neutral-400 mono ml-9 flex-wrap">
                    ...
                    <a
                      href={`/threads?lang=${thread.lang || 'all'}&page=1`}
